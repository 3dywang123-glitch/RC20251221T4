...
export const analyzeProfileOverview = async (url, screenshots, language = 'en', model = 'gemini-3-flash-preview') => {
...
// Post Analysis
export const analyzePost = async (content, images, language = 'en', model = 'gemini-3-flash-preview') => {
...
// Chat Log Analysis
export const analyzeChatLog = async (target, user, context, language = 'en', model = 'gemini-3-flash-preview') => {
    const isCn = language === 'cn';
    const langInstruction = isCn
        ? 'Respond in STRICT Simplified Chinese (简体中文). DO NOT use English in the output.'
        : 'Respond in English.';
...
export const analyzePersonalityV2 = async (profile, avatarB64, additionalImages, socialAnalysisHistory, postAnalysisHistory, consultationHistory, avatarAnalysis, supplementaryInfo, language = 'en', model = 'gemini-3-flash-preview') => {
...
// Avatar Analysis
export const analyzeAvatar = async (name, imageB64, model = 'gemini-2.0-flash-exp') => {
    const prompt = `
...
export const compressImage = async (base64Str, maxWidth = 800, quality = 0.6) => {
